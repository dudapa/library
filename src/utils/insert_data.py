...
if __name__ == "__main__":
    print("-----DEFAULT DATA WILL BE INSERTED-----")
    ...
    with conn, conn.cursor() as cursor:
        insert_genres_data_query=sql.SQL(
            """
        ...
        print(insert_genres_data_query.as_string(cursor))
        cursor.execute(insert_genres_data_query)

        insert_authors_data_query=sql.SQL(
            """
            INSERT INTO authors (author_name, author_surname, birthdate, nationality)
            ...
            INSERT INTO authors (author_name, author_surname, birthdate, nationality)
            VALUES ('Stephen', 'Chbosky', '1947-08-05', 'AUS');
            INSERT INTO authors (author_name, author_surname, birthdate, nationality)
        ...
        print(insert_authors_data_query.as_string(cursor))
        cursor.execute(insert_authors_data_query)

        insert_books_data_query=sql.SQL(
            """
            INSERT INTO books (book_name, page_count, author_id, genre_id, book_count)
        ...
        print(insert_books_data_query.as_string(cursor))
        cursor.execute(insert_books_data_query)
